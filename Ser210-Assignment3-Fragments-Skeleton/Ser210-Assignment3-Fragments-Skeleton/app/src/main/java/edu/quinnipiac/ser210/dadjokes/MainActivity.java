...
public class MainActivity extends AppCompatActivity {
    ...
    /*
    Sets the view, when the activity is created
    Grabs the toolbar ID and adds it to the activity
    Grabs the ID for the background image
    */
    ...
    /*
    On click method for the New Joke button, brings the user to the Joke activity, as well as fetching a new joke
     */
    ...
    /*
    Share option for the action bar
     */
    @Override
    ...
    /*
    Implementation for sharing a joke
    */
    ...
    /*
    Implementation for background changing in the action bar
     */
    @Override
    ...
    /*
    Grabs a random Joke from the API and sends it to the Joke Activity
     */
